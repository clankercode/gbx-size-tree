...
public static class ChunkCatalog
{
    private static readonly IReadOnlyCollection<ChunkMeta> Entries = Array.AsReadOnly(new[]
    {
        ...
        new ChunkMeta(0x0304305E, "Legacy macroblocks (stub)", SizeCategory.Metadata, "Always-empty legacy macroblock list; discarded on load", true, false, Optional: true),
        ...
        new ChunkMeta(0x03043061, "Write-only snapshot", SizeCategory.Metadata, "Nested object snapshot the game discards on load", true, false, Optional: true),
        ...
        new ChunkMeta(0x03043064, "Media-clip-group stub", SizeCategory.Metadata, "Always-empty media clip group list", true, false, Optional: true),
