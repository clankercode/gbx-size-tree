...
| Package | License | Use |
|---|---|---|
| [GBX.NET](https://github.com/BigBang1112/gbx-net) | MIT | Gbx parsing/serialization |
| [GBX.NET.LZO](https://github.com/BigBang1112/gbx-net) | **GPL-3.0-or-later** | LZO1x body (de)compression — the reason this tool is GPL |
| [GBX.NET.ZLib](https://github.com/BigBang1112/gbx-net) | MIT | zlib (lightmap cache) |
| [Spectre.Console](https://github.com/spectreconsole/spectre.console) | MIT | terminal rendering |
| [SixLabors.ImageSharp](https://github.com/SixLabors/ImageSharp) | Six Labors Split License (OSS exception applies to this GPL project) | thumbnail re-encode/downscale and infographic raster encoding |
